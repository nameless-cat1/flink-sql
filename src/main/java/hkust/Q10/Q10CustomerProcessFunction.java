...
public class Q10CustomerProcessFunction extends KeyedCoProcessFunction<Object, Node, Node, Node> {
    ...
    public void open(Configuration parameters) throws Exception {
        ValueStateDescriptor<Integer> count_descriptor = new ValueStateDescriptor<Integer>("customer alive number",Integer.class);
        ...
        ValueStateDescriptor<Set<Node>> set_descriptor = new ValueStateDescriptor<>("customer tmp node", tmp_node_descriptor);
