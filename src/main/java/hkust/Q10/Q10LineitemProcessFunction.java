...
public class Q10LineitemProcessFunction extends KeyedCoProcessFunction<Object, Node, Node, Node> {

    String next_key="CUSTKEY";
...
//        return true;
        if (node.getValueByName("L_RETURNFLAG").equals("R")){
            return true;
        }
        else {
            return false;
