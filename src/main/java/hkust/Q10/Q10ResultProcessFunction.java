...
public class Q10ResultProcessFunction extends KeyedProcessFunction<Object, Node, Node> {

    ValueState<Double>old_value;

    List<String>output_name= Arrays.asList("CUSTKEY","C_NAME","C_ACCTBAL","C_PHONE","C_ADDRESS","C_COMMENT","N_NAME");
