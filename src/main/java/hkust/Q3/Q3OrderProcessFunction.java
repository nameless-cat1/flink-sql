...
public class Q3OrderProcessFunction extends KeyedCoProcessFunction<Object, Node, Node, Node> {
...
//        return true;
        ...
        if (((Date) node.getValueByName("O_ORDERDATE")).compareTo(format.parse("1993-03-30"))<0 ){
            return true;
        }
        else {
            return false;
